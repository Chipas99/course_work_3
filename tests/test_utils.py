...
def test_mask_card_number():
    ...
    result = src.utils.mask_card_number(card_number)
    assert result == '1234 56** **** 5678', "Should mask card number correctly"
...
def test_prepare_user_message():
    ...
    result = src.utils.prepare_user_message(item)
    assert result == '12.10.2023 Some description\nСчет **5678 -> Карта 1234 56** **** 5678\n100 USD\n', "Should prepare message correctly"
